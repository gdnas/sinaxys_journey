...
select public.can_view_work_item('22222222-2222-4222-8222-222222222222'::uuid) as can_view_inserted,
       public.can_manage_work_item('22222222-2222-4222-8222-222222222222'::uuid) as can_manage_inserted;
rollback;