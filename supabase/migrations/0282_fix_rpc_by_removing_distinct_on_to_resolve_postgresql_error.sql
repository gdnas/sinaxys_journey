...
-- ============================================================================
-- Versão: 2.0 (Corrigido: removido DISTINCT ON desnecessário)
-- ============================================================================
...
-- ============================================================================
SELECT 
  'work_items_for_user_with_okr_context' as function_name,
  'Success - v2.0' as status,
  'Removed DISTINCT ON' as fix;
