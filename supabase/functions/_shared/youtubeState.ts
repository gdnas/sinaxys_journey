...
export async function signYouTubeOAuthState(payload: YouTubeOAuthStatePayload, secret: string) {
...
export async function verifyYouTubeOAuthState(state: string, secret: string) {
