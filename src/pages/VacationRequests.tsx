    ...
    <div className="mx-auto max-w-5xl">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-[color:var(--sinaxys-ink)]">Meus pedidos</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Faça um pedido e acompanhe aprovações. Você pode cancelar enquanto estiver <span className="font-medium">pendente</span>.
          </p>
        </div>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="rounded-3xl border-[color:var(--sinaxys-border)] p-0">
            <div className="rounded-3xl bg-white p-6">
              <DialogHeader>
                <DialogTitle className="text-[color:var(--sinaxys-ink)]">Solicitar férias</DialogTitle>
              </DialogHeader>
              ...
              <div className="mt-5 grid gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  />
                  <div className="text-xs text-muted-foreground">Dica: normalmente 10 dias, mas você pode ajustar.</div>
                </div>
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    if (!days || days < 1) {
                      toast({ title: "Informe a quantidade de dias" });
                      return;
                    }
                    ...
                    try {
                      ...
                      toast({ title: "Pedido enviado", description: "Seu pedido entrou como pendente." });
                      setOpen(false);
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="mt-2 text-sm text-[color:var(--sinaxys-ink)]">
                Você tem <span className="font-semibold">{pendingCount}</span> pedido(s) pendente(s).
              </div>
            </div>
        ...
        <Card className="rounded-3xl border-[color:var(--sinaxys-border)] bg-white p-0">
          <div className="flex items-center justify-between gap-4 px-5 py-4">
            <div>
              ...
              <div className="text-xs text-muted-foreground">Pedidos mais recentes primeiro.</div>
            </div>
          </div>
          <Separator />
          ...
          <div className="divide-y">
            {isLoading ? (
              ...
              <div className="p-6 text-sm text-muted-foreground">Você ainda não enviou nenhum pedido.</div>
            )}
          </div>
        </Card>
      </div>
