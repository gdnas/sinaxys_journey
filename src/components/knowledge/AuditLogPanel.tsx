                ...
                <div key={log.id} className="flex flex-col gap-4">
                  ...
                  <div className="border-l border-[color:var(--sinaxys-border)] rounded-2xl bg-[color:var(--sinaxys-bg)] p-4">
                    <div className="flex items-center justify-between gap-2">
                      <button
                        type="button"
                        className="flex items-center gap-2 rounded-xl bg-[color:var(--sinaxys-tint)] px-3 py-2 text-sm font-medium text-[color:var(--sinaxys-ink)] hover:bg-[color:var(--sinaxys-tint)]/60"
